...
export class ProcessedGeoDataIntroduction1678634503592
	implements MigrationInterface
{
	name = 'ProcessedGeoDataIntroduction1678634503592'
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`CREATE TABLE "processed_geo_data_raw_data_source_location_point" ("processedGeoDataId" varchar NOT NULL, "locationPointId" varchar NOT NULL, PRIMARY KEY ("processedGeoDataId", "locationPointId"))`,
		)
		await queryRunner.query(
